...
import 'package:bookingapp/Screens/hotelregistration.dart' as route2;

class ApartmentRegistration extends StatefulWidget {
  const ApartmentRegistration({Key? key}) : super(key: key);

  @override
  State<ApartmentRegistration> createState() => _ApartmentRegistrationState();
}

class _ApartmentRegistrationState extends State<ApartmentRegistration> {
  ...
  Widget build(BuildContext context) {
    ...
    final registeredField = TextFormField(
      //rgba(50, 54, 66, 1)
      style: TextStyle(
        fontFamily: 'Poppins',
        fontWeight: FontWeight.bold,
      ...
      onSaved: (value) {
        registeredController.text = value!;
      },
      ...
      decoration: InputDecoration(
        ...
        hintText: "Number of registered apartments",
    ...
    final passportField = TextFormField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: Icon(Icons.bathroom),
        contentPadding: EdgeInsets.fromLTRB(20, 20, 20, 15),
            ...
            child: Padding(
              ...
              MaterialPageRoute(builder: (context) => route1.MainScreen())),
                    ...
                    Align(
                      ...
                      child: Text("Apartment registration",
        ...
        children: [
          ...
          Theme(
            ...
            child: Checkbox(
              ...
              MaterialPageRoute(builder: (context) => route2.HotelRegistration()));
                setState(
                  () {
                    isMan = value!;
                    isWoman = false;
